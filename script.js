window.onload= function(){
    ...
    canvas.style.border="30px solid #9F551E ";
    canvas.style.margin="50px auto";
    canvas.style.display="block";
    canvas.style.backgroundImage=" url('snakefont.jpg')"
    ...
    function Snake(body,direction){
        ...
        this.checkCollision=function()
        {
            ...
            var isNotHorizontalWall=snakeX < minX || snakeX> maxX
            var isNotVerticalWall=snakeY < minY || snakeY> maxY;

            if(isNotHorizontalWall||isNotVerticalWall)
            {
                wallCollision=true;
            }
